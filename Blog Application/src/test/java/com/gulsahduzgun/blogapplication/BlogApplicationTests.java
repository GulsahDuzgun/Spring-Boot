...
// TEST
@SpringBootTest
class BlogApplicationTests implements ITestCRUD {

    // INJECTION
    private final IBlogCategoryRepository iBlogCategoryRepository;

    @Autowired
    public BlogApplicationTests(IBlogCategoryRepository iBlogCategoryRepository) {
        this.iBlogCategoryRepository = iBlogCategoryRepository;
    }

@BeforeAll
static void getBeforeBlogCategoriesAllMethod() {
    System.out.println("Blog Categories all hepsinde önce gelen");
