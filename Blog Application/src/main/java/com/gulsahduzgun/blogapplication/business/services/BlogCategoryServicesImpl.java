...
import com.gulsahduzgun.blogapplication.bean.ModelMapperBean;
import com.gulsahduzgun.blogapplication.business.dto.BlogCategoryDto;
import com.gulsahduzgun.blogapplication.business.services.impl.IBlogCategoryServices;
import com.gulsahduzgun.blogapplication.data.entity.BlogCategoryEntity;
import com.gulsahduzgun.blogapplication.data.repository.IBlogCategoryRepository;
import com.gulsahduzgun.blogapplication.exception.GulsahDuzgunException;
import com.gulsahduzgun.blogapplication.exception.NotFound404Exception;
    ...
    public BlogCategoryDto categoryServiceFindById(Long id) {
        ...
        */
        ...
        if (id != null) {
            ...
            throw new GulsahDuzgunException("İd null olarak geldi");
        }
